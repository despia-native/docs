...
- A service worker is caching the old web layer in a way that masks the new build. See [No OTA Updates](/troubleshooting/no-ota-updates) for the full service worker cleanup procedure.
