---
description: "Track installs, attribution, and in-app events across TikTok, Meta, Google, and organic channels using the Despia AppsFlyer bridge. Currently available on iOS, with Android coming soon."
icon: "circle-info"
title: "Introduction"
---

AppsFlyer attribution, deep linking, and event tracking. Fully bridged to your web layer. Know exactly where every user came from, route them to the right page on install, and send conversion events back to Meta and TikTok without writing a line of native code. Currently available on iOS, with Android support shipping shortly as a 1:1 port.
