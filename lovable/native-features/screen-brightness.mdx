...
description: "Control device scanning behavior with configurable modes (auto, on, off) and automatic screen brightness adjustment through your Lovable mobile app using the Despia SDK."
icon: "lightbulb"
---
...
<Card title="Lovable Prompt" icon="sparkles">
  Add scanning mode control functionality to my app using the Despia SDK from: https://www.npmjs.com/package/despia-native
