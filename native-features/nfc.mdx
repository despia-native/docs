...
<Steps>
  <Step title="Open Apple Developer">
    Sign in at [developer.apple.com](https://developer.apple.com) and go to **Certificates, Identifiers & Profiles \> Identifiers**.
  </Step>
  <Step title="Open your core bundle ID">
    Select the App ID that matches your app's core bundle ID (the one Despia builds against).
  </Step>
  <Step title="Enable NFC Tag Reading">
    Under **Capabilities**, tick **NFC Tag Reading** and save. Apple regenerates the provisioning profile with the new entitlement.
  </Step>
  <Step title="Enable NFC in the Despia Editor">
    Go to **App \> Addons** and toggle **NFC** on.
  </Step>
  <Step title="Rebuild a fresh native binary">
