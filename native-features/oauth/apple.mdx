---
title: "Apple Auth"
description: "Sign In with Apple, platform-aware. Native Face ID on iOS, Chrome Custom Tabs on Android, popup on web."
icon: "apple"
---
...
<Tabs>
  ...
  <Tab title="HTML">
    ...
    <script>
      ...
      var isDespiaIOS = isDespia && (
        navigator.userAgent.toLowerCase().includes('iphone') ||
        navigator.userAgent.toLowerCase().includes('ipad')
      )
    
      var isDespiaAndroid = isDespia &&
        navigator.userAgent.toLowerCase().includes('android')
