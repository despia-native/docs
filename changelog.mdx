...
<Update label="July 27, 2026" description="Usage Descriptions - editable iOS and Android permissions">
  ## Usage Descriptions
  ...
  **What ships today:**
  ...
  - **Editable purpose strings.** Each of the fourteen supported permissions has its own field. Write your own copy describing what your app does with the data, or use Revert to Default to restore the Despia wording and edit from there.
  ...
  - **Android manifest mapping.** The iOS keys are mapped to their Android equivalents. Filling in a usage description adds the matching feature and permission to the Android manifest, and clearing it removes them from both platforms. HealthKit keys are iOS only.
  - **Supported keys.** Camera, Microphone, Photo Library, Save to Photos, Location While Using, Background Location, Always-On Location, Contacts, Calendar, Face ID, Health Read, Health Write, Speech Recognition, and NFC Scanning.
